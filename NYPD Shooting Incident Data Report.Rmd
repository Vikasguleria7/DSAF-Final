...
#  geom_text(aes(label = value), vjust = -0.5, size = 4, color = "black") +  # Adding data labels
...
#NYPD_tidy
#sum(NYPD_tidy$Shootings)
NYPD_M <- NYPD_tidy %>% filter(VIC_SEX== 'M')
NYPD_M
sum(NYPD_M$Shootings)
sum(NYPD_F$STATISTICAL_MURDER_FLAG)
